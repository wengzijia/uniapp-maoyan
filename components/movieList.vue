...
<view>
  <button class="ticket" v-if="hotMovieData.showst === 3">购票</button>
  <button class="presell" v-if="hotMovieData.showst === 4">预售</button>
  <button class="wannaSee" v-if="hotMovieData.showst === 1">想看</button>
  <button class="preview" v-if="hotMovieData.showst === 2">点映</button>
</view>
</view>
</template>
...
<style>
	/* components/movieList/movieList.wxss */
	.movieListContainer{
	  display: flex;
	...
	.movieListContainer .imgWrap {
	    width: 128rpx;
	    height: 180rpx;
	}
	
	.movieListContainer .imgWrap image{
	  width: 128rpx;
	  height: 180rpx;
	} 
	
	.movieListContainer .content{
	  font-size: 22rpx;
	  width: 360rpx;
	}
	
	.movieListContainer .content .titleWrap {
	  display: flex;
	}
	
	.movieListContainer .content .titleWrap .title{
	  font-weight: 700;
	  font-size: 28rpx;
	}
	
	.movieListContainer .content .titleWrap  .max2d {
	  margin-left: 20rpx;
	...
	.movieListContainer .content .score{
	  color: #faaf00;
	}
	
	.movieListContainer  .ticket{
	  width: 140rpx;
	  margin-top: 60rpx;
	  font-size: 22rpx;
	  color: white;
